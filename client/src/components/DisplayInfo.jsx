function DisplayInfo({ userData }) {
  ...
  const checkingForNullIp = !city || !region || !timezone || !isp;

  return (
    <section className=" absolute z-30 top-40 mt-10 max-w-2xl md:max-w-4xl xl:max-w-6xl px-10 py-8 xl:py-14 mt-22 rounded-xl bg-white w-10/12 shadow-xl text-veryDarkGray">
